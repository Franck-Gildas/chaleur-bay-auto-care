    ...
    >
      <div className="wrap">
        ...
        >
          Pick up the phone,
          <br />
          or <span style={{ color: "var(--orange)" }}>fill out the form.</span>
        </h1>
        <p
          style={{
            maxWidth: 640,
        ...
        >
          We answer the phone with a real person, Monday to Saturday. Online
          requests are confirmed by call within the hour during business hours,
          and first thing the next morning otherwise.
        </p>
      </div>
    </section>
  );
  ...
  const bands = [
    {
      ...
      action: "tel:+15065551234",
      cta: "Call now",
    },
    {
      kicker: "Email",
      title: "hello@chaleurbayauto.ca",
      sub: "Replies in under 4 business hours",
      action: "mailto:hello@chaleurbayauto.ca",
      cta: "Send email",
    },
    {
      kicker: "Visit",
      title: "418 King Avenue · Bathurst",
      sub: "Mon – Fri · 7:30 – 17:30 · Sat · 8 – 14",
      action: "#map",
      cta: "Get directions",
    },
  ];
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setSubmitError(
          "Something went wrong. Please call us at (506) 555-1234 or try again.",
        );
      }
    } catch (_) {
      setSubmitError(
      ...
      <div className="wrap">
        <div className="sec-head reveal">
          ...
          <div className="sec-head__right">
            Roughly 2 minutes. We'll confirm by phone — you can adjust anything
            then.
          </div>
        </div>
                  ...
                  {services.map((s) => (
                    <button
                      ...
                      style={{
                        padding: "20px 18px",
                        background:
                          data.service === s.id ? "var(--orange)" : "var(--bg)",
                        color:
                          data.service === s.id ? "#0A1428" : "var(--text)",
                        border:
                          "1px solid " +
                          (data.service === s.id
                            ? "var(--orange)"
    ...
    >
      <div className="wrap">
        <div className="sec-head reveal">
          ...
          <div className="sec-head__right">
            Across from the Foodland, two minutes from Highway 11. Lots of
            parking, warm waiting room with real coffee.
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              <path
                d="M 0 100 Q 250 160 480 130 T 800 60 L 800 0 L 0 0 Z"
                fill="url(#bay2)"
              />
              <path
                d="M 0 100 Q 250 160 480 130 T 800 60"
                stroke="rgba(138,160,191,0.4)"
                fill="none"
              />
              {/* Roads */}
              <path
                d="M 100 480 L 100 280 Q 100 240 160 240 L 460 240 Q 500 240 500 280 L 500 400 Q 500 440 540 440 L 800 440"
                stroke="rgba(255,255,255,0.2)"
                strokeWidth="3"
                fill="none"
              />
              <path
                d="M 0 320 L 300 320 Q 340 320 340 360 L 340 480"
                stroke="rgba(255,255,255,0.1)"
                strokeWidth="1.5"
                fill="none"
              />
              <path
                d="M 520 480 L 520 320 Q 520 300 560 300 L 800 300"
                stroke="rgba(255,255,255,0.1)"
                strokeWidth="1.5"
                fill="none"
              />
          ...
          >
              ...
              >
                <tbody>
                  {[
                    ...
                    >
                      <td
                        style={{ padding: "10px 0", color: "var(--text-dim)" }}
                      >
                        {d}
                      </td>
                      <td
            ...
            >
              ...
              <div style={{ height: 10 }} />
              <a className="btn btn--ghost btn--block" href="tel:+15065551234">
                Call (506) 555-1234
              </a>
            </div>
          </div>
